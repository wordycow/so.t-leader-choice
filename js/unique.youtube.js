          ...
          events: {
            onStateChange: function(ev){
              ...
              if (ev.data === YT.PlayerState.ENDED && last !== today) {
                if (rewardBtn) { rewardBtn.textContent="보상을 받을 준비가 완료 됐습니다"; rewardBtn.disabled=false; rewardBtn.classList.add("ready"); }
                if (statusText) { statusText.textContent="✅ 시청 완료! 왼쪽 버튼을 눌러 보상을 받으세요."; statusText.className="mining-status done"; }
              }
            }
          }
        });
